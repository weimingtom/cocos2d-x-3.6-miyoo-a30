...
public:
	...
	virtual iPreferenceItem *createItem(int idx) override {
		return CreatePreferenceItem<tPreferenceItemConstant>(idx, PrefListSize, Caption);
	}
};
...
public:
	...
	virtual iPreferenceItem *createItem(int idx) override {
		return CreatePreferenceItem<tPreferenceItemCheckBox>(idx, PrefListSize, Caption,
...
public:
	...
	virtual iPreferenceItem *createItem(int idx) override {
		return CreatePreferenceItem<tPreferenceItemSelectList>(idx, PrefListSize, Caption,
	...
	virtual const std::vector<std::pair<std::string, std::string> >& getListInfo() override {
		if (!ListInited) {
			...
			for (auto p_it = TextFmtList.begin(); p_it != TextFmtList.end(); ++p_it)
			{
				...
				if (!fmt || 1) { //TVPIsSupportTextureFormat(fmt)) {
...
public:
	...
	virtual iPreferenceItem *createItem(int idx) override {
		iPreferenceItem *ret = CreatePreferenceItem<tPreferenceItemSubDir>(idx, PrefListSize, Caption);
...
public:
	...
	virtual iPreferenceItem *createItem(int idx) override {
		...
		ret->autorelease();
		ret->initFromInfo(idx, PrefListSize, Caption);
		return ret;
	}
};
...
public:
	...
	virtual iPreferenceItem *createItem(int idx) override {
		tPreferenceItemConstant* ret = CreatePreferenceItem<tPreferenceItemConstant>(idx, PrefListSize, Caption);
